...
import com.mwwl.api.Api

import com.mwwl.utils.InterceptorUtil
    ...
    override fun applyOptions(context: Context, builder: GlobalConfigModule.Builder) {
        ...
        builder.baseurl(Api.baseUrl)
                ...
                .okhttpConfiguration {//这里可以自己自定义配置 Okhttp 的参数
                    ...
                    okhttpBuilder.writeTimeout(60, TimeUnit.SECONDS)//全局的读取超时时间
                    okhttpBuilder.connectTimeout(60,TimeUnit.SECONDS)//全局的连接超时时间
                    okhttpBuilder.readTimeout(60,TimeUnit.SECONDS)//全局的读取超时时间
